...
export default function Blogs() {
  ...
  return (
    ...
    >
      ...
      <Box>
        <Grid container spacing={4} justifyContent="space-between" sx={{ mb: "70px" }}>
          ...
          <Grid item xs={12} md={4} lg={4}>
            <FiltersControl control="search" value={search} label="Search By Title" handleChange={(e) => setSearch(e.target.value)} submit={(e) => getBlogs()} />
          </Grid>
        </Grid>
        <Box>
